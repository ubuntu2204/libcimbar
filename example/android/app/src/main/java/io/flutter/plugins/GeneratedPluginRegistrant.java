...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.libcimbar.plugin.LibcimbarPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin libcimbar, com.libcimbar.plugin.LibcimbarPlugin", e);
    }
    try {
